...
if __name__ == "__main__":
    ...
    # input h5
    parser.add_argument('--infile', default='/home/zgs/X-ray/mimic_cxr/new_data/mimic_caption_anno_train.pkl', help='pkl file', type=str)
    parser.add_argument('--outfile', default='/home/zgs/X-ray/mimic_cxr/new_data/mimic_train_cider.pkl', help='output pickle file', type=str)
    parser.add_argument('--gts', default='/home/zgs/X-ray/mimic_cxr/new_data/mimic_train_gts.pkl', help='output pickle file', type=str)
    parser.add_argument('--image_ids', default='/home/zgs/X-ray/mimic_cxr/new_data/train_ids.txt', help='image id file', type=str)
