...
########################################## XRAY ##########################################
_K.NORMAL_LABEL = 'NORMAL_LABEL'
_K.ABNORMAL_LABEL = 'ABNORMAL_LABEL'
_K.SEMANTICS_ABNORMAL_PRED = 'SEMANTICS_ABNORMAL_PRED'
_K.SEMANTICS_NORMAL_PRED = 'SEMANTICS_NORMAL_PRED'
_K.EMBED_WEIGHT = 'EMBED_WEIGHT'
_K.STAGE = 'STAGE'
_K.MEM_LOSS = 'MEM_LOSS'
_K.SEMANTICS_NORMAL_MA = 'SEMANTICS_NORMAL_MA'
_K.SEMANTICS_NORMAL_FEATS = 'SEMANTICS_NORMAL_FEATS'
_K.SEMANTICS_ABNORMAL_FEATS = 'SEMANTICS_ABNORMAL_FEATS'
_K.TOKEN_WEIGHT = 'TOKEN_WEIGHT'
_K.LOSS_WEIGHT = 'LOSS_WEIGHT'